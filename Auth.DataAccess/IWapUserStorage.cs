...
namespace SH3H.WAP.Auth.DataAccess
{
    ...
    /// 定义用户数据访问对象
    /// </summary>
    public interface IWapUserStorage
    {
        /// <summary>
        /// 添加用户
        /// </summary>
        ...
        WapUser UpdateUser(string userKey ,WapUser user);
        ...
        /// <returns>用户对象列表</returns>
        IEnumerable<WapUser> SelectUsersByRoleKey(string roleKey);
        ...
        /// <returns></returns>
        bool DeleteRoleUserRelation(string userKey, string roleKey, System.Data.Common.DbTransaction trans = null);
        ...
        /// <param name="trans"></param>
        /// <returns></returns>
        bool AddRoleUserRelation(string userKey, string roleKey, string relationKey, System.Data.Common.DbTransaction trans = null);
        ...
        bool UpdateRoleUserRelation(IEnumerable<RoleUserRelation> deleteArr, IEnumerable<RoleUserRelation> addArr);
        ...
        /// <returns>用户信息</returns>
        IEnumerable<WapUser> SelectUserByAccount(string account);

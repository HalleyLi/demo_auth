...
namespace SH3H.WAP.Auth.Model.Dto
{
    ...
    public class WapAppUpdateDto
    {
        ...
        public static WapApp ToModel(WapAppUpdateDto dto)
        {
            if (dto == null)
            {
                return null;
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is WapAppUpdateDto)) return false;
            return ((WapAppUpdateDto)obj).AppIdentity == this.AppIdentity;
        }
